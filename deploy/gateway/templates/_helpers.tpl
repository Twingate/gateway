...
{{/*
Fail when no certificate is configured.
*/}}
{{- define "gateway.requireTlsCertificates" -}}
{{- if not (include "gateway.tlsSecretNames" . | fromJsonArray) }}
{{- fail "The Gateway needs at least one certificate. Set tls.certificates.autoGenerated.enabled to true or add an entry to tls.certificates.secrets." }}
{{- end }}
{{- end }}
