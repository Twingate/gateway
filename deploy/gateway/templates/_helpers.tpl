...
{{/*
Fail when TLS automation issuer CA certificate is not specified.
*/}}
...
{{- if and (not (include "gateway.tlsSecretNames" . | fromJsonArray)) (not (include "gateway.tlsAutomationEnabled" .)) }}
{{- fail "The Gateway needs at least one certificate. Set tls.certificates.autoGenerated.enabled to true, add an entry to tls.certificates.secrets, or configure tls.automation." }}
{{- end }}
{{- end }}
