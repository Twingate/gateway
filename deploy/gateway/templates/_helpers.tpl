...
The engine is cert-manager when tls.autoGenerated.certManager.issuerRef.name is set;
otherwise helm.
*/}}
...
{{- if and $cm $cm.issuerRef $cm.issuerRef.name -}}cert-manager{{- else -}}helm{{- end -}}
{{- end -}}
{{- end -}}
{{- end -}}
