...
type RequestHandlerFlushTrigger struct {
	cb func()
}
...
func (h *RequestHandler) parseRequestPayload(req *ssh.Request, target any) {
...
func (h *RequestHandler) handleRequest(req *ssh.Request, sessionSignals SessionSignals) {
...
func (h *RequestHandler) forwardRequest(req *ssh.Request) (accepted, startSession bool, command string) {
...
type RequestHandler struct {
	...
	flushTrigger <-chan RequestHandlerFlushTrigger
...
func (h *RequestHandler) handleRequests() SessionSignals {
