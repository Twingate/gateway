	...
	tests := []struct {
	...
	}{
		{
			...
			config: &Config{
				...
				MetricsPort: 9090,
				TLS: TLSConfig{
					CertificateSources: TLSCertificatesConfig{Files: []TLSCertificateFileKeyPair{{CertificateFile: "tls.crt", PrivateKeyFile: "tls.key"}}},
				},
		...
		},
		{
			...
			config: &Config{
				...
				Port:        8443,
				MetricsPort: 9090,
				TLS:         TLSConfig{CertificateSources: TLSCertificatesConfig{Files: []TLSCertificateFileKeyPair{{CertificateFile: "tls.crt", PrivateKeyFile: "tls.key"}}}},
				Kubernetes:  &KubernetesConfig{},
			},
			wantErr: false,
		},
...
func TestTLSConfig_Validate(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			tls:     TLSConfig{CertificateSources: TLSCertificatesConfig{Files: []TLSCertificateFileKeyPair{{CertificateFile: "tls.crt", PrivateKeyFile: "tls.key"}, {CertificateFile: "other.crt", PrivateKeyFile: "other.key"}}}},
			wantErr: false,
		},
		{
		...
		},
		{
			...
			tls:         TLSConfig{CertificateSources: TLSCertificatesConfig{Files: []TLSCertificateFileKeyPair{{PrivateKeyFile: "tls.key"}}}},
			wantErr:     true,
			errContains: "certificates.files[0]: required field is missing: certificateFile",
		},
		{
			name:        "file missing private key",
			tls:         TLSConfig{CertificateSources: TLSCertificatesConfig{Files: []TLSCertificateFileKeyPair{{CertificateFile: "tls.crt", PrivateKeyFile: "tls.key"}, {CertificateFile: "other.crt"}}}},
			wantErr:     true,
