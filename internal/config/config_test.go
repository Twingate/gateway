	...
	tests := []struct {
	...
	}{
		{
			...
			config: &Config{
				...
				MetricsPort: 9090,
				TLS: TLSConfig{
					Certificates: TLSCertificateSources{Files: []TLSCertificateFileKeyPair{{CertificateFile: "tls.crt", PrivateKeyFile: "tls.key"}}},
				},
		...
		},
		{
			...
			config: &Config{
				...
				Port:        8443,
				MetricsPort: 9090,
				TLS:         TLSConfig{Certificates: TLSCertificateSources{Files: []TLSCertificateFileKeyPair{{CertificateFile: "tls.crt", PrivateKeyFile: "tls.key"}}}},
				Kubernetes:  &KubernetesConfig{},
			},
			wantErr: false,
		},
...
func TestTLSConfig_Validate(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			tls:     TLSConfig{Certificates: TLSCertificateSources{Files: []TLSCertificateFileKeyPair{{CertificateFile: "tls.crt", PrivateKeyFile: "tls.key"}, {CertificateFile: "other.crt", PrivateKeyFile: "other.key"}}}},
			wantErr: false,
		},
		{
		...
		},
		{
			...
			tls:         TLSConfig{Certificates: TLSCertificateSources{Files: []TLSCertificateFileKeyPair{{PrivateKeyFile: "tls.key"}}}},
			wantErr:     true,
			errContains: "certificates.files[0]: required field is missing: certificateFile",
		},
		{
			name:        "file missing private key",
			tls:         TLSConfig{Certificates: TLSCertificateSources{Files: []TLSCertificateFileKeyPair{{CertificateFile: "tls.crt", PrivateKeyFile: "tls.key"}, {CertificateFile: "other.crt"}}}},
			wantErr:     true,
			errContains: "certificates.files[1]: required field is missing: privateKeyFile",
		},
		{
			name:        "duplicate certificate file",
			tls:         TLSConfig{Certificates: TLSCertificateSources{Files: []TLSCertificateFileKeyPair{{CertificateFile: "tls.crt", PrivateKeyFile: "tls.key"}, {CertificateFile: "tls.crt", PrivateKeyFile: "other.key"}}}},
			wantErr:     true,
